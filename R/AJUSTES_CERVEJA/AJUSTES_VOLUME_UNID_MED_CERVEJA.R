...
## AJUSTA VALORES COM NA
df_cerveja$VOLUME_SEFAZ <- ifelse(is.na(df_cerveja$VOLUME_SEFAZ),-1,df_cerveja$VOLUME_SEFAZ)
df_cerveja$UN_MEDIDA_SEFAZ <- ifelse(is.na(df_cerveja$UN_MEDIDA_SEFAZ),"-1",df_cerveja$UN_MEDIDA_SEFAZ)

## INSERE PRODUTO CHOPP NA TABELA
...
source("./SCRIPTS/FUNCOES/FN_AJUSTA_NULOS.R")


fwrite(df_cerveja,"./DADOS/nfe_cerveja2015e16.csv",sep = ";")
rm(df_cerveja)
gc(reset = T)
#######################################################################
##                          FINAL DOS AJUSTES                        ##
